...
* The optional "zz" segment is a strictly-two-digit base47i-encoded integer (ranging from zero to 2208) which gives an exponential "order-of-magnitude" for the referenced file size as interpreted above.
